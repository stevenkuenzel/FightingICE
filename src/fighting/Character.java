...
//    public int ownSpeedX = 0;
//    public int ownSpeedY = 0;
//    public int distanceToCentre = 0;
...
//	}
    ...
    /**
     * Initializes the AI fighter.
     *
     * @param characterName The name of the character.
     * @param playerNumber  P1: true, P2: false
     * @param cdi           Character information from the drive.
     * @param fighting      The Fighting instance.
     */
    public void initialize(String characterName, boolean playerNumber, CharacterDiskInformation cdi, Fighting fighting) {

        CharacterDiskInformation.InformationContainer information = cdi.get(characterName);

        this.graphicSizeX = information.graphicSizeX;
        this.graphicSizeY = information.graphicSizeY;
        this.graphicAdjustX = information.graphicAdjustX;
        this.graphicAdjustInitialX = information.graphicAdjustInitialX.clone();

        this.playerNumber = playerNumber;

        this.motionList = new ArrayList<>(information.motionList);
    ...
    public void initializeList() {
        ...
        this.processedCommands = new LinkedList<>();
     ...
     */
    public void roundInit(int distance) {
        this.hp = 0;
        this.energy = 0;
        ...
        if (this.playerNumber) {
            // P1. Standing left.
            this.front = true;
            this.x = 100 + (distance / 2) + this.graphicAdjustInitialX[0];
        } else {
            // P2. Standing right.
            this.front = false;
            this.x = 460 - (distance / 2) + this.graphicAdjustInitialX[1];
        }
    ...
    /**
     * Determines whether (and how) an attack hits the Character.
     *
     * @param opponent     The attacking opponent.
     * @param attack       Attack instance.
     * @param currentFrame Current frame of the round.
     * @return True, if the opponent was able to block the attack. Otherwise false.
     */
    public boolean hitAttack(Character opponent, Attack attack, int currentFrame) {
        ...
        boolean isGuard = isGuard(attack);
    ...
    private void createAttackInstance() {
        ...
        if (startActive(motion)) {
            ...
            boolean isAttack = motion.getAttackHitDamage() > 0;
            int id = isAttack ? NEXT_ATTACK_ID++ : -1;
...
//                this.numOfOccurredHitBoxes++;
            ...
            this.attack.initialize(this.playerNumber, this.x, this.y, this.graphicSizeX, this.front, id);
        }
    }
    ...
    /**
     * Destroys the attack instance.
     */
    public void destroyAttackInstance() {
        destroyAttackInstance(true);
    }

    /**
     * Destroys the attack instance.
     * @param markAsDestroyed Mark the underlying attack instance as destroyed?
     */
    public void destroyAttackInstance(boolean markAsDestroyed) {
        if (this.attack == null)
        {
            return;
        }
    ...
    public Deque<Key> getInputCommand() {
        return new LinkedList<>(this.inputCommands);
    }
    ...
    public Deque<Key> getProcessedCommand() {
        return new LinkedList<>(this.processedCommands);
    }
...
//            if (this.hitCount >= 2) {
//                totalComboCount += this.hitCount * this.hitCount;
//            }
//        }
