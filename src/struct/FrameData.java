...
public class FrameData {
    ...
    public FrameData(CharacterData[] characterData, int currentFrame, int currentRound,
        ...
        this.projectileData = new LinkedList<>();
    ...
    public FrameData(FrameData frameData) {
        this.characterData = new CharacterData[]{frameData.getCharacter(true), frameData.getCharacter(false)};
    ...
    public Deque<AttackData> getProjectiles() {
        ...
        LinkedList<AttackData> attackList = new LinkedList<>();
